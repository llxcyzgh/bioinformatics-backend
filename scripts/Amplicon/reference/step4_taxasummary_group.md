...
|--------|------|------|----------|----------|----------|
| Relative_group/ | 分组相对丰度表目录 | DIR | 16S/18S/ITS | 通用 | (${AMPLICON_ROOT}/examples/step4_taxasummary_group/Relative_group/) |
...
| 文件名 | 描述 | 格式 | 适用组学 | 适用物种 | 示例文件 |
|--------|------|------|----------|----------|----------|
| cluster/cluster.p.png/pdf | 门水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
| cluster/cluster.c.png/pdf | 纲水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
| cluster/cluster.o.png/pdf | 目水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
| cluster/cluster.f.png/pdf | 科水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
| cluster/cluster.g.png/pdf | 属水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
| cluster/cluster.s.png/pdf | 种水平分组热图 | PNG/PDF | 16S/18S/ITS | 通用 | - |
...
source .env
bash step4_taxasummary_group.sh ...
```
...
- **脚本位置**: `${AMPLICON_ROOT}/scripts/step4_taxasummary_group.sh`
- **参考文档**: `${AMPLICON_ROOT}/reference/step4_taxasummary_group.md`
- **示例数据**: `${AMPLICON_ROOT}/examples/step4_taxasummary_group/`
